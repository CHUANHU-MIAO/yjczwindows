...
pub struct App {
    ...
    // 启动盘制作
    pub usb_boot_state: UsbBootState,
...
impl Default for App {
    fn default() -> Self {
        ...
        Self {
            ...
            usb_boot_state: UsbBootState::default(),
        }
    }
}
...
impl eframe::App for App {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::SidePanel::left("nav_panel")
            ...
            .show(ctx, |ui| {
                ...
                if !easy_mode {
                    ...
                    if ui
                        .add_enabled(
                            !is_busy || self.current_panel == Panel::UsbBoot,
                            egui::SelectableLabel::new(self.current_panel == Panel::UsbBoot, "📀 启动U盘"),
                        )
                        .clicked()
                    {
                        self.current_panel = Panel::UsbBoot;
                    }
                }
        ...
        egui::CentralPanel::default().show(ctx, |ui| match self.current_panel {
            ...
            Panel::UsbBoot => self.show_usb_boot(ui),
        });
